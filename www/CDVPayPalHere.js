...
exports.initializeMerchant = function (args, success, error) {
  args = args || {}
  cordova.exec(success, error, 'CDVPayPalHere', 'initializeMerchantCDV', [
...
exports.connectToReader = function (args, success, error) {
  args = args || {}
  cordova.exec(success, error, 'CDVPayPalHere', 'connectToReaderCDV', [
  ])
}

exports.searchAndConnectToReader = function (args, success, error) {
  args = args || {}
  cordova.exec(success, error, 'CDVPayPalHere', 'searchAndConnectToReaderCDV', [
  ])
}

exports.takePayment = function (args, success, error) {
  args = args || {}
  cordova.exec(success, error, 'CDVPayPalHere', 'takePaymentCDV', [
